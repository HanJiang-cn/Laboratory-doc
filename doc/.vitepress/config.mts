...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Q&A', link: '/api-examples' },
      { text: '实验室主要项目', 
        items: [
          { text: '前言', link: '/preface' },
          { text: '重点项目', 
            items: [
              { text: '项目1', link: '/getting-started' },
              { text: '项目2', link: '/configuration' },
              { text: '项目3', link: '/deployments' },
            ]
           },
          { text: '竞赛项目', 
            items: [
    ...
    //编辑本页
    editLink: { 
      pattern: 'https://github.com/HanJiang-cn/Laboratory-doc/edit/main/docs/:path', // 改成自己的仓库
      text: '在GitHub编辑本页'
    },
